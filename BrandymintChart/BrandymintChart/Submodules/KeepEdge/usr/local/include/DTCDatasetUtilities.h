...
@interface DTCDatasetUtilities : NSObject {
 ...
 */
+ (double) calculatePieDatasetTotal: (id <DTCIPieDataset>) aDataset;
 ...
 */
+ (BOOL) isEmptyOrNullWithPieDataset: (id <DTCIPieDataset>) aDataset;

/*
 *	Returns true if the dataset is empty (or null), and false otherwise.
 */
+ (BOOL) isEmptyOrNullWithCategoryDataset: (id <DTCICategoryDataset>) aDataset;

/*
 *	Returns true if the dataset is empty (or null), and false otherwise.
 */
+ (BOOL) isEmptyOrNullWithXYDataset: (id <DTCIXYDataset>) aDataset;
  
/*
 *	Returns the range of values in the domain (x-values) of a dataset.
 */
+ (DTCRange *) findDomainBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset;
   
/*
 *	Returns the range of values in the domain (x-values) of a dataset.
 */
+ (DTCRange *) findDomainBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset includeInterval: (BOOL) isIncludeInterval;
	
/*
 *	Returns the bounds of the x-values in the specified dataset taking into account only the visible series
 *	and including any x-interval if requested.
 */
+ (DTCRange *) findDomainBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset
						   visibleSeriesKeys: (NSMutableArray *) aKeys
							 includeInterval: (BOOL) isIncludeInterval;

/*
 *	Iterates over the items in an XYDataset to find the range of x-values. If the dataset is an instance of
 *	IntervalXYDataset, the starting and ending x-values will be used for the bounds calculation.
 */
+ (DTCRange *) iterateDomainBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset;

/*
 *	Iterates over the items in an XYDataset to find the range of x-values.
 */
+ (DTCRange *) iterateDomainBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset includeInterval: (BOOL) isIncludeInterval;
	   
/*
 *	Returns the range of values in the range for the dataset.
 */
+ (DTCRange *) findRangeBoundsWithCategoryDataset: (id <DTCICategoryDataset>) aDataset;

/*
 *	Returns the range of values in the range for the dataset.
 */
+ (DTCRange *) findRangeBoundsWithCategoryDataset: (id <DTCICategoryDataset>) aDataset includeInterval: (BOOL) isIncludeInterval;
 ...
 */
+ (DTCRange *) findRangeBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset;
 ...
 */
+ (DTCRange *) findRangeBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset includeInterval: (BOOL) isIncludeInterval;
			
/*
 *	Finds the bounds of the y-values in the specified dataset, including only those series that are listed in visibleSeriesKeys,
 *	and those items whose x-values fall within the specified range.
 */
+ (DTCRange *) findRangeBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset
						  visibleSeriesKeys: (NSMutableArray *) aKeys
									 xRange: (DTCRange *) aXRange
							includeInterval: (BOOL) isIncludeInterval;
 ...
 */
+ (DTCRange *) iterateXYRangeBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset;

/*
 *	Iterates over the data item of the xy dataset to find the range bounds.
 */
+ (DTCRange *) iterateRangeBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset;
 ...
 */
+ (DTCRange *) iterateToFindDomainBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset
									visibleSeriesKeys: (NSMutableArray *) aKeys
									  includeInterval: (BOOL) isIncludeInterval;

/*
 *	Returns the range of y-values in the specified dataset for the data items belonging to the visible series
 *	and with x-values in the given range.
 */
+ (DTCRange *) iterateToFindRangeBoundsWithXYDataset: (id <DTCIXYDataset>) aDataset
								   visibleSeriesKeys: (NSMutableArray *) aKeys
											  xRange: (DTCRange *) aXRange
									 includeInterval: (BOOL) isIncludeInterval;
 ...
 */
+ (DTCRange *) findStackedRangeBoundsWithCategoryDataset: (id <DTCICategoryDataset>) aDataset;
							 
/*
 *	Returns the minimum and maximum values for the dataset's range (y-values), assuming that the series in one category are stacked.
 */
+ (DTCRange *) findStackedRangeBoundsWithCategoryDataset: (id <DTCICategoryDataset>) aDataset base: (double) aBase;
