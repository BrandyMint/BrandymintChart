...
#import "IPCBarStacked3DChart.h"
#import "DTCICategoryDataset.h"
#import "DTCDefaultCategoryDataset.h"

@interface DemoBarStacked3DChart (Private)
...
@implementation DemoBarStacked3DChart
...
{
	IPCBarStacked3DChart *pChart = [IPCBarStacked3DChart new];
	
	[pChart setOrientation: kIPCOrientationVertical];
	
	[DemoBarStacked3DChart getTitleWithTitle: [pChart getTitle]];
	
	NSMutableArray *pSubTitles = [DemoBarStacked3DChart getSubTitles];
	[pChart setSubTitles: pSubTitles];
	[pSubTitles release];
	
	[DemoBarStacked3DChart getLegendWithLegend: [pChart getLegend]];
	
	[DemoBarStacked3DChart getCategoryAxisWithAxis: [pChart getDomainAxis]];
	
	[DemoBarStacked3DChart getValueAxisWithAxis: [pChart getRangeAxis]];
	
	[DemoBarStacked3DChart getRenderWithRender: (IPCRenderBar *)[pChart getRender]];
	
	id <DTCICategoryDataset> pDataset = [DemoBarStacked3DChart getDataset];
...
@implementation DemoBarStacked3DChart (Private)
