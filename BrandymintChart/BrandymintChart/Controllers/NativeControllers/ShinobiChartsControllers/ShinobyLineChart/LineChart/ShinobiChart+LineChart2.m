...
@implementation ShinobiChart (LineChart2)
...
- (NSString*)seriesTitleForKey:(NSString*)key {
    ...
    if ([key isEqualToString:opera]) {
        title = @"Opera";
    } else if ([key isEqualToString:android]) {
        title = @"Android";
    } else if ([key isEqualToString:safari]) {
        title = @"Safari";
    } else if ([key isEqualToString:nokia]) {
        title = @"Nokia";
    } else if ([key isEqualToString:blackberry]) {
        title = @"BlackBerry";
